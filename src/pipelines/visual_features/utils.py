...
from src.pipelines.visual_features.models.vgg19 import getModelVariables as getVgg19Variables
from src.pipelines.visual_features.models.inception3 import getModelVariables as getIncp3Variables
